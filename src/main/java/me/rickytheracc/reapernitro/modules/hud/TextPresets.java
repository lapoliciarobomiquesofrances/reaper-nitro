package me.rickytheracc.reapernitro.modules.hud;
...
public class TextPresets {
    public static final HudElementInfo<TextHud> INFO = new HudElementInfo<>(Reaper.HUD_GROUP, "reaper-text", "Displays arbitrary text with Starscript.", TextPresets::create);
