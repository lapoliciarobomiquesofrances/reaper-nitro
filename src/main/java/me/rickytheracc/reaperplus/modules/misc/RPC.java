...
public class RPC extends Module {
    ...
    public RPC() {
        super(ReaperPlus.M, "reaper-presence", "Discord RPC for Reaper");
        runInMainMenu = true;
    }
    ...
    public void onActivate() {
        ...
        if (rgbLogo.get()) {
            ...
            rpc.setLargeImage(getImgKey(), "Reaper " + ReaperPlus.VERSION);
        }
    }
    ...
    private void setImage(String imgKey) {
        rpc.setLargeImage(imgKey, "Reaper " + ReaperPlus.VERSION);
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            mainT = "Reaper " + ReaperPlus.VERSION;
            subT = getScreenName();
        }
