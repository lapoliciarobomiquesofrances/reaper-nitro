...
public class ChatTweaks extends Module {
    ...
    public ChatTweaks() {
        super(ReaperPlus.C, "chat-tweaks", "Various tweaks to the chat and prefix controller.");
    }
    ...
    public void onDeactivate() {
        ChatUtils.unregisterCustomPrefix("me.rickytheracc.reaperplus");
    ...
    private void handlePrefix() {
        if (isActive()) {
            ChatUtils.registerCustomPrefix("me.rickytheracc.reaperplus", this::getPrefix);
