...
import me.rickytheracc.reaperplus.modules.combat.ReaperSelfTrap;
...
public class BedAlerts extends Module {
    ...
    public BedAlerts() {
        super(ReaperPlus.C, "bed-alerts", "Alerts you about nearby players with beds in their inventory.");
    }
