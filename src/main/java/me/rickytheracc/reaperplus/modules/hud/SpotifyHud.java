...
public class SpotifyHud extends HudElement {
    public static final HudElementInfo<SpotifyHud> INFO = new HudElementInfo<>(ReaperPlus.HUD_GROUP, "spotify-hud", "Display the current song playing in spotify.", SpotifyHud::new);
