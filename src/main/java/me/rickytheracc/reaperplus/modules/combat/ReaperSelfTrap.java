...
public class ReaperSelfTrap extends Module {
        ...
        switch (mode.get()) {
            case Normal -> {
                switch (placeMode.get()) {
                    ...
                    case AntiFacePlace -> positions.addAll(BlockHelper.getBlockList(center, BlockHelper.BlockListType.DoubleSurround));
                    case Full -> {
                        positions.addAll(BlockHelper.getBlockList(center, BlockHelper.BlockListType.SelfTrap));
